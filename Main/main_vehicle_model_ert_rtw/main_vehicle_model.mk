...
## Generated on : Wed May 29 23:13:33 2024
...
PRODUCT_NAME              = main_vehicle_model
MAKEFILE                  = main_vehicle_model.mk
...
COMPILER_COMMAND_FILE     = main_vehicle_model_comp.rsp
CMD_FILE                  = main_vehicle_model.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/main_vehicle_model.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DINTERNAL_XCP_MEM_BLOCK_1_SIZE=160 -DINTERNAL_XCP_MEM_BLOCK_1_NUMBER=1 -DINTERNAL_XCP_MEM_BLOCK_2_SIZE=168 -DINTERNAL_XCP_MEM_BLOCK_2_NUMBER=5 -DINTERNAL_XCP_MEM_BLOCK_3_SIZE=40 -DINTERNAL_XCP_MEM_BLOCK_3_NUMBER=5 -DINTERNAL_XCP_MEM_RESERVED_POOLS_TOTAL_SIZE=2422 -DINTERNAL_XCP_MEM_RESERVED_POOLS_NUMBER=6 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=2 -DXCP_MIN_EVENT_NO_RESERVED_POOL=7 -DXCP_MAX_CTO_SIZE=255 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2000 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=1
...
DEFINES_STANDARD = -DMODEL=main_vehicle_model -DNUMST=5 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
LIBS = C:/ProgramData/MATLAB/SupportPackages/R2023b/3P.instrset/cmsis_dsp.instrset/Lib/GCC/arm_cortexm7ldfsp_math/libCMSISDSP.a
...
%.o : $(START_DIR)/main_vehicle_model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/main_vehicle_model_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/main_vehicle_model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/main_vehicle_model_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/main_vehicle_model_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_AnalogOutput.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/mbed/src/MW_AnalogOutput.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/main_vehicle_model_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


main_vehicle_model.o : $(START_DIR)/main_vehicle_model_ert_rtw/main_vehicle_model.c
	$(CC) $(CFLAGS) -o "$@" "$<"


main_vehicle_model_data.o : $(START_DIR)/main_vehicle_model_ert_rtw/main_vehicle_model_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
MW_InterruptIn.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/mbed/src/MW_InterruptIn.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


mw_mbed_interface.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/stmnucleo/STM32F746ZG/src/mw_mbed_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


BufferedSerial.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/mbed/src/BufferedSerial.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


stm32nucleof7xx_init_board.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/stmnucleo/STM32F746ZG/src/stm32nucleof7xx_init_board.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mbed_syscalls.o : C:/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/target/supportpackages/mbed/src/GCC/mbed_syscalls.c
	$(CC) $(CFLAGS) -o "$@" "$<"
