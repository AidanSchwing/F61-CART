...
## Generated on : Sun Feb 04 20:30:00 2024
...
COMPILER_COMMAND_FILE     = led_flash_comp.rsp
CMD_FILE                  = led_flash.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/led_flash.elf
...
DEFINES_STANDARD = -DMODEL=led_flash -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
CPP_LDFLAGS_ = @C:\Users\Aidan\DOCUME~1\F61-CART\LED_FL~1\MBED_O~1.RSP
...
CPP_SHAREDLIB_LDFLAGS_ = @C:\Users\Aidan\DOCUME~1\F61-CART\LED_FL~1\MBED_O~1.RSP
...
%.o : $(START_DIR)/led_flash_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/led_flash_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/led_flash_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/led_flash_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/led_flash_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
led_flash.o : $(START_DIR)/led_flash_ert_rtw/led_flash.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rt_zcfcn.o : $(START_DIR)/led_flash_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
